...
set_property PACKAGE_PIN V17 [get_ports {enable_factor}]
	set_property IOSTANDARD LVCMOS33 [get_ports {enable_factor}]
...
#set_property PACKAGE_PIN W19 [get_ports down]
...
#Sch name = JB10
#set_property PACKAGE_PIN C16 [get_ports {reset_out}]
#set_property IOSTANDARD LVCMOS33 [get_ports {reset_out}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_wave_ph1_out}]
#Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {pwm_wave_ph2_out}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_wave_ph2_out}]
#Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {pwm_wave_ph3_out}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_wave_ph3_out}]
#Sch name = JC4
